  ...
  return (
    ...
    >
      <ul>
        ...
        <li onClick={() => scrollTo('writing')} className={styles.normal}>
          <span>01.</span>Publications<span></span>
        </li>
        <li onClick={() => scrollTo('work')} className={styles.normal}>
          <span>02.</span>Experiences<span></span>
        </li>
        <li onClick={() => scrollTo('contact')} className={styles.normal}>
          <span>03.</span>Contact<span></span>
        </li>
        <ThemeSwitch
