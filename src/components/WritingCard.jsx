  ...
  return (
    ...
    >
      <div className={styles.wrapper}>
        ...
        <Tooltip title={writing.title}>
          <div className={styles.title}>{writing.title}</div>
        </Tooltip>
        <div className={styles.content}>
          {writing.content}
          {/* Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
          industry&aposs standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
